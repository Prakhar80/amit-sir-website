...
const demandCourses: Course[] = [
  ...
  {
    id: 4,
    title: "Docker & Kubernetes (CKA)",
    code: "CKA-2024",
    icon: "🐳",
    badge: "CNCF Certified",
    duration: "30 Days",
    price: "₹15,000",
    originalPrice: "₹25,000",
    discount: "40% OFF",
    image: "https://images.unsplash.com/photo-1667372393119-3d4c48d07fc9?auto=format&fit=crop&w=400&q=80",
    features: ["Container Orchestration", "Microservices", "DevOps Integration", "Cloud Native"],
    level: "Advanced",
    demand: "Ultra High",
    rating: 4.9,
    students: "2.1K+",
  ...
  },
  {
    ...
    discount: "42% OFF",
    image: "https://images.unsplash.com/photo-1618477388954-7852f32655ec?auto=format&fit=crop&w=400&q=80",
    features: ["Automation Scripts", "Configuration Management", "CI/CD Pipelines", "Infrastructure as Code"],
    level: "Intermediate",
    demand: "High",
    rating: 4.7,
    students: "2.3K+",
  ...
  },
  {
    ...
    features: ["Infrastructure as Code", "Cloud Provisioning", "Multi-Cloud", "State Management"],
    level: "Intermediate",
    demand: "Very High",
    rating: 4.6,
    students: "1.4K+",
    ...
    urlPath: "/terraform/infrastructure-automation"
  },
  {
    id: 9,
    ...
    discount: "43% OFF",
    image: "https://images.unsplash.com/photo-1526379095098-d400fd0bf935?auto=format&fit=crop&w=400&q=60",
    features: ["Django/Flask", "Database Design", "API Development", "Frontend Integration"],
    level: "Intermediate",
    demand: "Ultra High",
    rating: 4.8,
    students: "2.9K+",
