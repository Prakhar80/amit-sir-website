          ...
          <div className="border-b border-white/10 py-12">
            <div className="max-w-7xl mx-auto px-4 text-center">
              <h3 className="text-2xl md:text-3xl font-bold mb-4">
                Stay Updated with Latest <span className="bg-gradient-to-r from-yellow-400 to-orange-400 bg-clip-text text-transparent">Tech Trends</span>
              </h3>
              ...
              <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                <input
                  ...
                  className="flex-1 px-4 py-3 rounded-xl bg-white/10 backdrop-blur-md border border-white/20 text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-blue-400"
                />
                <button className="bg-gradient-to-r from-blue-500 to-purple-600 px-6 py-3 rounded-xl font-semibold hover:scale-105 transition-all duration-300 shadow-lg">
                  Subscribe 🚀
                </button>
              </div>
            </div>
          ...
          <div className="border-t border-white/10 py-8">
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="flex flex-wrap justify-center gap-3 md:gap-6 text-sm text-white/60">
                <button onClick={() => setPolicyModal({isOpen: true, type: 'privacy'})} className="hover:text-white transition-colors duration-300">Privacy Policy</button>
                <span className="text-white/30">|</span>
                <button onClick={() => setPolicyModal({isOpen: true, type: 'terms'})} className="hover:text-white transition-colors duration-300">Terms & Conditions</button>
                <span className="text-white/30 hidden sm:inline">|</span>
                <button onClick={() => setPolicyModal({isOpen: true, type: 'refund'})} className="hover:text-white transition-colors duration-300">Refund Policy</button>
                <span className="text-white/30 hidden sm:inline">|</span>
                <button onClick={() => setPolicyModal({isOpen: true, type: 'cancellation'})} className="hover:text-white transition-colors duration-300">Cancellation Policy</button>
              </div>
